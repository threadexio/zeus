complete -c zeus -n "__fish_use_subcommand" -l color -d 'Colorize the output' -r -f -a "{never	,always	,auto	}"
...
complete -c zeus -n "__fish_seen_subcommand_from sync" -s h -l help -d 'Print help'
complete -c zeus -n "__fish_seen_subcommand_from remove" -l uninstall -d 'Uninstall packages after remove'
complete -c zeus -n "__fish_seen_subcommand_from remove" -s h -l help -d 'Print help'
complete -c zeus -n "__fish_seen_subcommand_from build" -s h -l help -d 'Print help'
complete -c zeus -n "__fish_seen_subcommand_from query" -s b -l by -d 'Query AUR packages by' -r -f -a "{name	,namedesc	,maintainer	,depends	,makedepends	,optdepends	,checkdepends	}"
...
complete -c zeus -n "__fish_seen_subcommand_from query" -s h -l help -d 'Print help'
complete -c zeus -n "__fish_seen_subcommand_from runtime" -s l -l list -d 'List all available runtimes'
complete -c zeus -n "__fish_seen_subcommand_from runtime" -s h -l help -d 'Print help'
...
complete -c zeus -n "__fish_seen_subcommand_from completions" -s h -l help -d 'Print help'
